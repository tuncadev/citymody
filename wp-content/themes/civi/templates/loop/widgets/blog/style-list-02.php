...
?>
	...
	<div <?php post_class(implode(' ', $classes)); ?>>
		<div class="post-wrapper civi-box <?php if( $i == 1 && $settings['big_first'] == 1 ) { echo ' post-big'; } ?>">
				...
				<div class="post-thumbnail-wrapper">
					<div class="post-feature post-thumbnail civi-image">
						<a href="<?php the_permalink(); ?>">
							<?php
							$size = Civi_Image::elementor_parse_image_size($settings, '540x330');
