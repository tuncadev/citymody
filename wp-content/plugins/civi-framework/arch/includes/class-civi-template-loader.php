	...
	class Civi_Template_Loader
	{
		...
		private function template_candidate_hooks()
		{
			...
			$candidate_details_order_default = array(
				'sort_order' => 'enable_sp_head|enable_sp_about_me|enable_sp_photos|enable_sp_video|enable_sp_skills|enable_sp_experience|enable_sp_education|enable_sp_projects|enable_sp_awards',
				'enable_sp_head' => 'enable_sp_head',
			...
			$head_nb_order = $about_me_nb_order = $photos_nb_order = $video_nb_order = $skills_nb_order = $experience_nb_order = $education_nb_order = $projects_nb_order = $awards_nb_order = 0;
