...
<div class="<?php echo join(' ', $jobs_item_class); ?>" data-jobid="<?php echo esc_attr($id); ?>">
	<div class="jobs-archive-header">
		<div class="jobs-header-left">
			...
			<div class="jobs-left-inner">
				...
				<h3 class="jobs-title"><a
						href="<?php echo get_post_permalink($jobs_id) ?>"><?php echo get_the_title($jobs_id) ?></a>
				</h3>
				<?php endif; ?>
	...
	<div class="jobs-archive-footer">
		...
		<div class="jobs-footer-right">
			<p class="days">
				<span> <?php echo civi_get_expiration_apply($jobs_id); ?>
				</span><?php esc_html_e('days left to apply', 'civi-framework') ?>
			</p>
		</div>
	</div>
